...
//definindo contrato para calculo das multas para Alunos
public class MultaAlunoStrategy implements CalculadoraMultaStrategy {

    private static final double VALOR_DIARIO = 1.50;
